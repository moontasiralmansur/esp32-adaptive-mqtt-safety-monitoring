...
Node-RED, mobile applications, TLS, authentication, over-the-air updates,
machine-learning, or dashboards. These are not part of the implemented system
and are potential future extensions only.
